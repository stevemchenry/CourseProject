...
The software consists of the frontend user interface component and the backend data processing and storage components. The frontend engages in bidirectional communication with the backend using the Chrome extension message passing API. The implementation of each components is described in the following sections.
